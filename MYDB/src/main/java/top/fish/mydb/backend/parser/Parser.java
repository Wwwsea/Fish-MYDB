package top.fish.mydb.backend.parser;

import java.util.ArrayList;
import java.util.List;

import top.fish.mydb.backend.parser.statement.Abort;
import top.fish.mydb.backend.parser.statement.Begin;
import top.fish.mydb.backend.parser.statement.Commit;
import top.fish.mydb.backend.parser.statement.Create;
import top.fish.mydb.backend.parser.statement.Delete;
import top.fish.mydb.backend.parser.statement.Drop;
import top.fish.mydb.backend.parser.statement.Insert;
import top.fish.mydb.backend.parser.statement.Select;
import top.fish.mydb.backend.parser.statement.Show;
import top.fish.mydb.backend.parser.statement.SingleExpression;
import top.fish.mydb.backend.parser.statement.Update;
import top.fish.mydb.backend.parser.statement.Where;
